...
function zmlab2.Meth.DrawHUD(pos,scale,m_type,m_amount,m_quality)
    ...
    cam.Start3D2D(pos, Angle(0, LocalPlayer():EyeAngles().y - 90, 90), scale)
        ...
        draw.SimpleText(m_amount .. zmlab2.config.UoM, zmlab2.GetFont("zmlab2_font01"), -50, 50, zmlab2.colors["white01"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        zmlab2.util.DrawOutlinedBox(-100, 30, 100, 40, 2, methData.color)

        draw.SimpleText(m_quality .. "%", zmlab2.GetFont("zmlab2_font01"), 50, 50, zmlab2.colors["white01"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
