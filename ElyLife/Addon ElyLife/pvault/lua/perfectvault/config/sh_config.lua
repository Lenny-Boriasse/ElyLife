...
perfectVault.Config.AccessGroups["STEAM_0:1:123456"] = true
...
perfectVault.Config.HalloweenModels = true
...
perfectVault.Config.AllowAnyoneToRob = true

hook.Add("AirLoaded", "pvault_load_jobs", function() -- Ignore this line, this just sets up the jobs so they load at the correct time.
    ...
    perfectVault.Config.Government[TEAM_POLICE] = true
    perfectVault.Config.Government[TEAM_CPOLICE] = true
    perfectVault.Config.Government[TEAM_HCCOMMANDEMENT] = true
    perfectVault.Config.Government[TEAM_CHIEF] = true
    perfectVault.Config.Government[TEAM_BAC] = true
    perfectVault.Config.Government[TEAM_RAID] = true
    perfectVault.Config.Government[TEAM_RAIDCHEF] = true
