...
local function zmlab2_OptionPanel(name,desc, CPanel, cmds)
	...
	if desc then
		...
		desc_pnl:SetTextColor(zmlab2.colors["white01"])
	...
	for k, v in ipairs(cmds) do
		...
		elseif v.class == "DButton" then
			...
			item:SetTextColor(zmlab2.colors["white01"])
		...
		elseif v.class == "DColorMixer" then
			...
			a_title:SetTextColor(zmlab2.colors["white01"])
...
hook.Add("AddToolMenuCategories", "zmlab2_CreateCategories", function()
	spawnmenu.AddToolCategory("Options", "Zero´s Methlab 2", "Zero´s Methlab 2")
end)

hook.Add("PopulateToolMenu", "zmlab2_PopulateMenus", function()
	spawnmenu.AddToolMenuOption("Options", "Zero´s Methlab 2", "zmlab2_Settings", "Client Settings", "", "", Methlab2_settings)
	spawnmenu.AddToolMenuOption("Options", "Zero´s Methlab 2", "zmlab2_Admin_Settings", "Admin Settings", "", "", Methlab2_admin_settings)
