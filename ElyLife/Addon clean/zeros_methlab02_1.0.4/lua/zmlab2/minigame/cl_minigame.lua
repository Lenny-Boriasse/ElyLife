...
function MiniGameVGUI:Init()
    ...
    MainContainer.Paint = function(s, w, h)
        ...
        //zmlab2.util.DrawOutlinedBox(0 * zmlab2.wM, 0 * zmlab2.hM, w, h, 6, zmlab2.colors["white01"])
...
function MiniGameVGUI:Paint(w, h)
    ...
    draw.SimpleText(zmlab2.language["SPACE"], zmlab2.GetFont("zmlab2_vgui_font01"), w / 2 , 35, zmlab2.colors["white01"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
