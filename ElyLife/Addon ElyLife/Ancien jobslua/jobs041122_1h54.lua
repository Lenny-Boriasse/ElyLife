hook.Add('RP_CustomJobs', 'gmodlife', function()
  ...
  Racket : ✘
      ...
      Printer : ✘ 
      Racket : ✘]],
            weapons = {  "weapon_fists", "tfa_wolftno_doublebarrel"},
            command = "convoyeur",
            max = 4,
            salary = 20,
            etoiles = 4,
  ...
  Printer : ✘
  Racket : ✘  ]],
            weapons = {"weapon_stungun", "weapon_fists", "salute", "tfa_colt1911", "nightstick", "door_ram", "weapon_checker", "weaponchecker", "weapon_cuff_police", "policebadge", "weapon_rpt_stungun", "weapon_rpt_handcuff", "weapon_rdo_radio", "weapon_rpt_finebook"},
            command = "cp",
            max = 25,
            salary = 20,
            admin = 0,
  ...
  La Brigade De Policiers D’Elite (ou RAID) ne dépend pas de votre commandement, elle vous est supérieure.
  
  Catéorie d'armes : ★★
  Printer : ✘
  Racket : ✘]],
            weapons = {"weapon_acracker_default","salute", "weapon_fists", "tfa_colt1911", "nightstick", "door_ram", "weapon_checker", "weapon_cuff_police", "policebadge", "weapon_baton", "weapon_rpt_stungun", "weapon_rpt_handcuff", "weapon_rdo_radio", "weapon_rpt_finebook", "tfa_bo3_olympia", "voice_amplifier"},
            command = "chief",
            max = 3,
            admin = 0,
            salary = 80,
  ...
  Racket : ✔
      ...
      TEAM_VIPMAFIEUX = DarkRP.createJob("*VIP* Mafieux", {
            color = Color(255, 0, 127, 255),
            model = {"models/kerry/citizens/male_01_mafia.mdl", "models/kerry/citizens/male_02_mafia.mdl", "models/kerry/citizens/male_03_mafia.mdl",	
  ...
  Racket : ✔
      ...
      TEAM_METH = DarkRP.createJob("Fabricant de meth", {
            ...
            model = "models/niko_bellic/slow.mdl",
            description = [[
  ...
  -- PERSO --        
     ...
     TEAM_CARTELNOCHE = DarkRP.createJob("*WL* Cartel Noche", {
      ...
      TEAM_RAID = DarkRP.createJob("*WL* RAID", {
            ...
            model = {"models/player/raid/raid_02.mdl", "models/player/raid/raid_02.mdl", "models/player/raid/raid_03.mdl", "models/player/raid/raid_04.mdl", "models/player/raid/raid_06.mdl", "models/player/raid/raid_05.mdl", "models/player/raid/raid_07.mdl"},
            description = [[
      WL RAID
      Catéorie d'armes : ★★★★
      Printer : ✔
      ...
      TEAM_RAIDCHEF = DarkRP.createJob("*WL* Chef RAID", {
            color = Color(0, 68, 255),
            model = {"models/player/raid/raid_01.mdl", "models/player/raid/raid_02.mdl", "models/player/raid/raid_03.mdl", "models/player/raid/raid_04.mdl", "models/player/raid/raid_06.mdl", "models/player/raid/raid_05.mdl", "models/player/raid/raid_07.mdl"},    
            description = [[
      WL RAID
      Catéorie d'armes : ★★★★
      Printer : ✔
      ...
      weapons = {"weapon_stungun", "weapon_fists", "salute", "tfa_colt1911", "stungun", "arrest_stick", "nightstick", "door_ram", "weapon_checker", "weaponchecker", "weapon_cuff_police", "policebadge"},
      command = "capstrak",
      max = 1,
      salary = 10000,
      admin = 0,
