hook.Add('RP_CustomJobs', 'gmodlife', function()
  ...
  Racket : ✘
      ...
      TEAM_GOUVERNEUR = DarkRP.createJob("*WL* Gouverneure", {
            ...
            "models/players/mj_tew2_myra_npc.mdl",
  },
      ...
      TEAM_VGOUVERNEUR = DarkRP.createJob("*WL* Vice-Gouverneur", {
            color = Color(173, 45, 18, 255),
            model = { 
            "models/player/suits/male_08_closed_coat_tie.mdl", "models/bloocobalt/science/jarmy_09.mdl"
  },
      ...
      TEAM_SECRETSERVICE = DarkRP.createJob("*WL* Garde Républicaine", {
            ...
            description = [[ Vous êtes membre du gouvernement]],
            weapons = { "weapon_fists", "weapon_cuff_police", "stunstick", "salute_swep", "cross_arms_swep", "cross_arms_infront_swep", "stungun"},
      ...
      TEAM_CONVOYEUR_VIP = DarkRP.createJob("*VIP* Convoyeur Brinks", {
            ...
            customCheck = function(ply)
                  return table.HasValue({"VIP", "VIP+", "superadmin", "Ultimate", "Divin", "Premium", "admin", "Moderateur", "Premium+", "Moderateur Senior","Maitre de jeu","Manager","Administrateur","Modérateur-Confirmé","Modo-Test", "Légende"}, ply:GetNWString("usergroup"))
            end,
            PlayerDeath = function(ply, weapon, killer)
  ...
  Le commissaire & la BPE sont vos supérieurs hiérarchiques. Les gardiens de la paix sont au même grade que vous.
  ...
  Racket : ✘
            ...
            weapons = { "weapon_morpher", "salute", "weapon_stungun", "weapon_fists", "stungun", "arrest_stick", "unarrest_stick", "tfa_colt1911", "nightstick", "door_ram", "weapon_checker", "weapon_cuff_police", "policebadge"},
            command = "bac",
            max = 4,
            salary = 50,
            category = "Police",
            ...
            vote = false,
            customCheck = function(ply)
                  return table.HasValue({"VIP", "Super-Admin", "VIP+", "superadmin", "Divin", "Premium", "admin","Ultimate", "Moderateur Senior", "Moderateur", "Premium+", "Moderateur Senior","Maitre de jeu","Manager","Administrateur","Modo-Test","Modérateur-Débutant", "Légende"}, ply:GetNWString("usergroup"))
            end,
            hasLicense = true,
            jobType = "vip",
            hasRadio = true,
  ...
  Racket : ✘
            ...
            hasLicense = false,
            customCheck = function(ply)
                  return table.HasValue({"VIP", "Super-Admin", "VIP+", "superadmin", "Divin", "Premium", "admin","Ultimate", "Moderateur Senior", "Moderateur", "Premium+", "Moderateur Senior","Maitre de jeu","Manager","Administrateur","Modérateur-Confirmé","Modo-Test", "Légende"}, ply:GetNWString("usergroup"))
            end,
            PlayerDeath = function(ply, weapon, killer)
                  ply:teamBan()
                  ply:changeTeam(GAMEMODE.DefaultTeam, true)
  ...
  Racket : ✘
      ...
      TEAM_POLICE = DarkRP.createJob("Gardien de la Paix", {
            ...
            model = {"models/kerry/citizens/male_01_police.mdl", "models/kerry/citizens/male_02_police.mdl", "models/kerry/citizens/male_03_police.mdl", "models/kerry/citizens/male_04_police.mdl", "models/kerry/citizens/female_01_police.mdl"},
            description = [[
  ...
  Vous devez obéir aux ordres du commissaire et de la BPE.
  ...
  Dans le cas d’un code X lancé par la BPE, vous ne pourrez pas aider le maire. Par conséquent, vous devrez être du côté de la BPE.
  ...
  Printer : ✘
  Racket : ✘  ]],
            weapons = {"weapon_stungun", "weapon_fists", "salute", "tfa_colt1911", "stungun", "arrest_stick", "unarrest_stick", "nightstick", "door_ram", "weapon_checker", "weaponchecker", "weapon_cuff_police", "policebadge"},
            command = "cp",
            max = 25,
            salary = 20,
            admin = 0,
  ...
  La Brigade De Policiers D’Elite (ou BPE) ne dépend pas de votre commandement, elle vous est supérieure.
  
  Catéorie d'armes : ★★
  Printer : ✘
  Racket : ✘]],
            weapons = {"weapon_acracker_default", "stungun", "salute", "weapon_fists", "arrest_stick", "unarrest_stick", "tfa_colt1911", "nightstick", "door_ram", "weapon_checker", "weapon_cuff_police", "policebadge", "weapon_baton"},
            command = "chief",
            max = 3,
            admin = 0,
            salary = 80,
  ...
  Racket : ✔
            ...
            hasLicense = false,
            customCheck = function(ply)
                  return table.HasValue({"VIP", "Super-Admin", "VIP+", "superadmin", "Divin", "Modo-Test", "Premium","Ultimate", "admin", "Moderateur Senior", "Moderateur", "Premium+", "Moderateur Senior","Maitre de jeu","Manager","Administrateur","Modérateur-Confirmé","Modérateur-Débutant", "Légende"}, ply:GetUserGroup())
            end,
            hasRadio = true,
            PlayerDeath = function(ply, weapon, killer)
                  ply:teamBan()
  ...
  Racket : ✔
            ...
            vote = false,
            customCheck = function(ply)
                  return table.HasValue({"VIP", "Super-Admin", "VIP+", "superadmin", "Divin", "Premium","Ultimate", "admin", "Modo-Test", "Moderateur Senior", "Moderateur", "Premium+", "Moderateur Senior","Maitre de jeu","Manager","Administrateur","Modérateur-Confirmé","Modérateur-Débutant", "Légende"}, ply:GetUserGroup())
            end,
            hasLicense = true,
            jobType = "vip",
            hasRadio = true,
  ...
  Racket : ✔
            ...
            hasLicense = false,
            customCheck = function(ply)
                  return table.HasValue({"VIP", "Super-Admin", "VIP+", "superadmin", "Divin", "Premium", "Modo-Test","Ultimate", "admin", "Moderateur Senior", "Moderateur", "Premium+", "Moderateur Senior","Maitre de jeu","Manager","Administrateur","Modérateur-Confirmé","Modérateur-Débutant", "Légende"}, ply:GetUserGroup())
            end,
            hasRadio = true,
            PlayerDeath = function(ply, weapon, killer)
                  ply:teamBan()
  ...
  Racket : ✔
      ...
      TEAM_VIPMAFIEUX = DarkRP.createJob("*VIP* Mafieux", {
            color = Color(255, 0, 127, 255),
            model = {"models/kerry/citizens/male_01_mafia.mdl", "models/kerry/citizens/male_02_mafia.mdl", "models/kerry/citizens/male_03_mafia.mdl", "models/kerry/citizens/male_04_mafia.mdl", "models/sentry/suanro/male_01_closed_coat_tiepm.mdl",
        "models/sentry/suanro/male_02_closed_coat_tiepm.mdl",
                    ...
                    "models/sentry/suanro/male_01_open_waistcoatpm.mdl",
                    "models/sentry/suanro/male_02_open_waistcoatpm.mdl",
                    "models/sentry/suanro/male_03_open_waistcoatpm.mdl",
                    "models/sentry/suanro/male_04_open_waistcoatpm.mdl",
                    "models/sentry/suanro/male_05_open_waistcoatpm.mdl",
                    "models/sentry/suanro/male_06_open_waistcoatpm.mdl",
                    "models/sentry/suanro/male_07_open_waistcoatpm.mdl",
                    "models/sentry/suanro/male_08_open_waistcoatpm.mdl",
                    "models/sentry/suanro/male_09_open_waistcoatpm.mdl"
                },
            description = [[
  Vous êtes le représentant et le chef de la mafia, vous êtes celui qui prend les décisions pour l’organisation des activités de votre famille.
  Les membres de votre gang se trouvant déjà en action RP lorsque vous spawnez ne sont pas obligé de vous suivre dans vos activités.
...
TEAM_ZBF_HACKER = DarkRP.createJob("Hackeur", {
  ...
  TEAM_MERCENAIRE = DarkRP.createJob("*VIP* Mercenaire", {
      ...
      Racket : ✔
            ...
            hasRadio = true,
            hasLicense = true,
            customCheck = function(ply) return table.HasValue({"VIP", "VIP+", "superadmin", "Ultimate", "Modo-Test", "Divin", "Premium", "admin", "Moderateur", "Premium+", "Moderateur Senior","Maitre de jeu","Manager","Administrateur","Modérateur-Confirmé","Modérateur-Débutant", "Légende"}, ply:GetNWString("usergroup")) end,
            jobType = "vip",
  ...
  Racket : ✘
            ...
            jobType = "vip",
            customCheck = function(ply)
                  return table.HasValue({"VIP", "Super-Admin", "VIP+", "superadmin", "Divin","Ultimate", "Modo-Test", "Premium", "admin", "Moderateur Senior", "Moderateur", "Premium+", "Moderateur Senior","Maitre de jeu","Manager","Administrateur","Modérateur-Confirmé","Modérateur-Débutant", "Légende"}, ply:GetNWString("usergroup"))
            end,
            PlayerDeath = function(ply, weapon, killer)
                  ply:teamBan()
                  ply:changeTeam(GAMEMODE.DefaultTeam, true)
  ...
  Racket : ✘
      ...
      TEAM_PROCUREUR = DarkRP.createJob("*WL* Procureur", {
            color = Color(255, 0, 127, 255),
            model = {"models/players/mj_tew2_theodore.mdl"},
            description = [[
  Vous êtes le représentant et le chef de la mafia, vous êtes celui qui prend les décisions pour l’organisation des activités de votre famille.
  Les membres de votre gang se trouvant déjà en action RP lorsque vous spawnez ne sont pas obligé de vous suivre dans vos activités.
  ...
  Racket : ✘
      ...
      TEAM_AVOCAT = DarkRP.createJob("*VIP* Avocat", {
            color = Color(255, 0, 127, 255),
            model = {"models/player/bobert/AOBruce.mdl"},
            description = [[
  ...
  Racket : ✘
            ...
            admin = 0,
            hasLicense = false,
            customCheck = function(ply) return table.HasValue({"VIP", "VIP+", "superadmin", "Ultimate", "Divin", "Premium", "Modo-Test", "admin", "Moderateur", "Premium+", "Moderateur Senior","Maitre de jeu","Manager","Administrateur","Modérateur-Confirmé","Modérateur-Débutant", "Légende"}, ply:GetNWString("usergroup")) end,
            hasRadio = true,
            PlayerDeath = function(ply, weapon, killer)
                  ply:teamBan()
                  ply:changeTeam(GAMEMODE.DefaultTeam, true)
  ...
  TEAM_WOLFSKOV = DarkRP.createJob("*WL* Cartel Wolvsköv", {
            color = Color(0, 0, 0, 255),
                  model = {"models/sentry/sentryoldmob/mafia/sentrymobmale4pm.mdl",
                        ...
                        "models/sentry/sentryeightmob/misc/sentrychigoon1male4pm.mdl",
                        "models/sentry/sentryeightmob/misc/sentrymexgangmale4pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrychibossmale2pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrychibossmale6pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentryprosmale4pm.mdl",
                        "models/sentry/sentryeightmob/misc/sentrybusi2male5pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrybusi3male7pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrybusi3male4pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrybusi3male6pm.mdl",
                        "models/sentry/sentryeightmob/misc/sentrysoucent2male3pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrykorlitmale2pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrykorlitmale4pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrychibossmale8pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrykorbossmale6pm.mdl",
                        "models/sentry/sentryeightmob/mafia/sentrykorbossmale5pm.mdl"
                  },
            description = [[
      WL pour les Vindicta Letum.
      Catéorie d'armes : ★★★★
      Printer : ✔
      Racket : ✔
      ]],
            weapons = {   "weapon_fists", "advancedrobbery_cellphone", "jewelry_robbery_hammer", "salute"},
            command = "wolfskov",
            max = 20,
            salary = 2000,
            admin = 0,
      ...
      TEAM_WOLF = DarkRP.createJob("*WL* Organisation Wölf", {
            color = Color(0, 0, 0, 255),
                  model = {"models/player/plague_doktor/PLAYER_Plague_Doktor.mdl", "models/player/ocelot.mdl"},
            description = [[
      WL pour Reaper.
      Catéorie d'armes : ★★★★
      Printer : ✔
      ...
      TEAM_BRUSCA = DarkRP.createJob("Famille Brusca", {
        color = Color(0, 0, 0, 255),
     ...
     TEAM_CARTELNOCHE = DarkRP.createJob("Cartel Noche", {
        color = Color(0, 0, 0, 255),
      ...
      TEAM_OXFORDCORP = DarkRP.createJob("Oxford Corporation", {
        color = Color(0, 0, 0, 255),
      ...
      TEAM_BPE = DarkRP.createJob("*WL* BPE", {
      ...
      Racket : ✔  
            ...
            weapons = {   "weapon_fists", "sg_adrenaline","weapon_cuff_standard", "weapon_cuff_elastic", "garde_a_vousv1.2", "nightstick", "weapon_policeshield", "weapon_rpw_binoculars", "weapon_extinguisher", "weapon_sh_smokegrenade","weapon_sh_flashbang", "tfa_apex_kunai", "tfa_cso_g_deagle","wcd_speedchecker","door_ram","weapon_sh_doorcharge","tfa_ithacam37", "weapon_cuff_police", "salute"},
            command = "bpe",
            max = 35,
            salary = 25,
            admin = 0,
      ...
      TEAM_BPECHEF = DarkRP.createJob("*WL* Chef BPE", {
            color = Color(0, 68, 255),
            model = {"models/player/r6s_doc.mdl"},      
            description = [[
      WL BPE
      ...
      TEAM_CAPSTRAKOV = DarkRP.createJob("Strakov S.W.A.T", {
      color = Color(25, 25, 170, 255),
      model = { "models/minson97/bo2/seal.mdl",
            "models/minson97/bo2/seal_masked.mdl"
            },
      description = [[ Job Perso ]],
      weapons = {"weapon_stungun", "weapon_fists", "salute", "tfa_colt1911", "stungun", "arrest_stick", "unarrest_stick", "nightstick", "door_ram", "weapon_checker", "weaponchecker", "weapon_cuff_police", "policebadge"},
      command = "capstrak",
      max = 1,
      salary = 10000,
      ...
      customCheck = function(ply) return
            table.HasValue({"STEAM_0:1:446473810"}, ply:SteamID())
      end,  
      PlayerDeath = function(ply, weapon, killer)
            ply:teamBan(TEAM_CAPSTRAKOV,300)
            ply:changeTeam(GAMEMODE.DefaultTeam, true)
      end
      })
      ...
      TEAM_SPIDER = DarkRP.createJob("Araignée", {
            color = Color(0, 0, 0, 255),
            model = {
                  "models/darkmessiah/spider_regular.mdl"
            },
            description = [[
            ]],
            weapons = {},
      ...
      TEAM_CLARI = DarkRP.createJob("*WL* Clarividencia ", {
            color = Color(0, 0, 0, 255),
                  model = {"models/sentry/sentryeightmob/misc/sentrysoucent2male1pm.mdl",
                  "models/sentry/sentryeightmob/misc/sentrysoucent2male1pm.mdl",
                  "models/sentry/sentryeightmob/misc/sentryhighsecmale3pm.mdl",
                  "models/sentry/sentryeightmob/misc/sentryhighsecmale1pm.mdl",
                  "models/sentry/sentryeightmob/mafia/sentrykorlitmale1pm.mdl",
                  "models/sentry/sentryeightmob/mafia/sentrykorlitmale3pm.mdl",
                  },
            description = [[
                  Clarividencia (Cubain)
      Catéorie d'armes : ★★★★
      Printer : ✔
      Racket : ✔
      ]],
...
"models/player/dod_german.mdl",
                  ...
                  category =  "Gunfight",
                        customCheck = function(ply)
                              return ( table.HasValue({"Super-Admin", "superadmin", "Légende","Divin", "Premium","Premium+", "Ultimate"}, ply:GetNWString("usergroup")) ) and ( tonumber(os.date("%H")) > 15 or tonumber(os.date("%H")) < 9 )
                        end,
                  PlayerDeath = function(ply, weapon, killer)
...
"models/player/dod_german.mdl",
                        ...
                        category =  "Gunfight",
                              customCheck = function(ply)
                                    return ( table.HasValue({"Super-Admin", "superadmin", "Légende","Divin"}, ply:GetNWString("usergroup")) ) and ( tonumber(os.date("%H")) > 15 or tonumber(os.date("%H")) < 9 )
                              end,
                        PlayerDeath = function(ply, weapon, killer)
  ...
  ---------------------------------------------------------------------------]]
      ...
      GM:AddChatTeam("Police", {TEAM_MAYOR, TEAM_POLICE, TEAM_CHIEF, TEAM_BAC, TEAM_BPECHEF, TEAM_BPE})
  
      GM:AddChatTeam("Maire", {TEAM_MAYOR, TEAM_BODYMAYOR, TEAM_SECRETARY, TEAM_BPECHEF, TEAM_BPE})
      GM:AddChatTeam("BPE", {TEAM_BPECHEF, TEAM_BPE})
  
      GM:AddDoorGroup("Organisation Wolvsköv", TEAM_WOLFSKOV)
      GM:AddDoorGroup("Hôpital", TEAM_MEDIC)
      GM:AddDoorGroup("Mairie", TEAM_POLICE, TEAM_MAYOR, TEAM_CHIEF, TEAM_BAC, TEAM_BODYMAYOR, TEAM_CPOLICE, TEAM_HCCOMMANDEMENT, TEAM_BPECHEF, TEAM_BPE)
      GM:AddDoorGroup("Poste de Police", TEAM_POLICE, TEAM_CPOLICE, TEAM_HCCOMMANDEMENT, TEAM_CHIEF, TEAM_BAC, TEAM_POLICECHIEN, TEAM_BPE, TEAM_BPECHEF, TEAM_GOUVERNEUR, TEAM_VGOUVERNEUR, TEAM_GOUVERNEMENT, TEAM_SECRETSERVICE)
      GM:AddDoorGroup("Locaux B.P.E", TEAM_CHIEF, TEAM_BPE, TEAM_BPECHEF, TEAM_GOUVERNEUR, TEAM_VGOUVERNEUR, TEAM_GOUVERNEMENT, TEAM_SECRETSERVICE)
      ...
      GM:AddDoorGroup("Tribunal", TEAM_POLICE, TEAM_MAYOR, TEAM_CHIEF, TEAM_BAC, TEAM_HCCOMMANDEMENT, TEAM_BPECHEF, TEAM_BPE)
      GM:AddDoorGroup("Prison", TEAM_POLICE, TEAM_CHIEF, TEAM_BAC, TEAM_HCCOMMANDEMENT, TEAM_CAPSTRAKOV, TEAM_BPECHEF, TEAM_BPE)
      GM:AddDoorGroup("Gouvernement", TEAM_CHIEF, TEAM_CPOLICE, TEAM_HCCOMMANDEMENT, TEAM_BPECHEF, TEAM_BPE, TEAM_GOUVERNEUR, TEAM_VGOUVERNEUR, TEAM_GOUVERNEMENT, TEAM_SECRETSERVICE)
