...
// What language should we display en , fr , de , ru , es , pl , tr
...
zmlab2.config.Damageable = {
	["zmlab2_machine_ventilation"] = 100,
	["zmlab2_storage"] = 110,
	...
	["zmlab2_item_acid"] = 15,
	["zmlab2_item_aluminium"] = 14,
	["zmlab2_item_lox"] = 25,
	["zmlab2_item_methylamine"] = 21,

	["zmlab2_item_meth"] = 15,
	["zmlab2_item_crate"] = 15,
	["zmlab2_item_palette"] = 15,
}
...
zmlab2.config.Police = {
	...
	Jobs = {
		//[TEAM_AGENT_POLICE] = true,
    [TEAM_AGENT_POLICE_WL] = true,
    [TEAM_COMMISSAIRE] = true,
    [TEAM_BAC] = true,
    [TEAM_GIGN] = true,
    [TEAM_CHEF_GIGN] = true,
    [TEAM_MAIRE] = true,
    [TEAM_GENDARMEMOTO] = true
	},
...
zmlab2.config.Lockpick = {
	...
	Wanted_enabled = true,
	Wanted_time = 120,
	Wanted_msg = "Porte déverrouiller!",
}
