...
perfectVault.Icons = {}
perfectVault.Icons[1] = {name = "money-bag", url = "https://0wain.xyz/icons/money-bag.png", mat = Material("data/pvault_data/ui/money-bag.png")}
perfectVault.Icons[2] = {name = "padlock", url = "https://0wain.xyz/icons/padlock.png", mat = Material("data/pvault_data/ui/padlock.png")}
perfectVault.Icons[3] = {name = "police", url = "https://0wain.xyz/icons/police.png", mat = Material("data/pvault_data/ui/police.png")}
perfectVault.Icons[4] = {name = "alarm", url = "https://0wain.xyz/icons/alarm.png", mat = Material("data/pvault_data/ui/alarm.png")}

perfectVault.Core.LoadIcons = function()
	for k, v in pairs(perfectVault.Icons) do
		if file.Exists( "pvault_data/ui/"..v.name..".png", "DATA" ) then continue end

		http.Fetch( v.url, function( body, len, headers, code )
			file.Write("pvault_data/ui/"..v.name..".png", body)
			v.mat = Material("data/pvault_data/ui/"..v.name..".png")
		end)
	end
end

perfectVault.Core.LoadIcons()
