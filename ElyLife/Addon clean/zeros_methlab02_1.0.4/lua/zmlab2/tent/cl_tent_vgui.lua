    ...
    if LocalPlayer().zmlab2_TentFold == true then
        zmlab2.Interface.Create(600,365,zmlab2.language["Deconstruct"],function(pnl)
            ...
            local function AddLabel(txt,font)
                ...
                Textbox01:SetTextColor(zmlab2.colors["white01"])
            ...
            FoldButton.Paint = function(s, w, h)
                ...
                draw.SimpleText(zmlab2.language["TentFoldAction"], zmlab2.GetFont("zmlab2_vgui_font03"), w / 2 , h / 2, zmlab2.colors["white01"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        ...
        zmlab2.Interface.Create(700,470,zmlab2.language["SelectTentType"],function(pnl)
            ...
            function(MainContainer,item_size)
                ...
                NoneButton.Paint = function(s, w, h)
                    ...
                    draw.SimpleText(zmlab2.language["TentType_None"], zmlab2.GetFont("zmlab2_vgui_font02"), w / 2 , h / 2, zmlab2.colors["white01"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
            ...
            BuildButton.Paint = function(s, w, h)
                ...
                draw.SimpleText(zmlab2.language["TentAction_Build"], zmlab2.GetFont("zmlab2_vgui_font03"), w / 2 , h / 2, zmlab2.colors["white01"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
