...
function zmlab2.vgui.Slider(parent,text,start_val,onChange)
	...
	p.Paint = function(s, w, h)
		...
		draw.SimpleText(text, zmlab2.GetFont("zmlab2_vgui_font03"),5 * zmlab2.wM, h / 2, zmlab2.colors["white01"], TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)

		draw.SimpleText(math.Round(s.slideValue * 100), zmlab2.GetFont("zmlab2_vgui_font03"),w - 5 * zmlab2.wM, h / 2, zmlab2.colors["white01"], TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
...
function zmlab2.vgui.CheckBox(parent,text,state,onclick)
	...
	p.Paint = function(s, w, h)
		...
		draw.SimpleText(text, zmlab2.GetFont("zmlab2_vgui_font03"),w / 2, BoxHeight * 0.8, zmlab2.colors["white01"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
function zmlab2.vgui.TextEntry(parent, emptytext,onchange,hasrefreshbutton,onRefresh)
	...
	p.Paint = function(s, w, h)
		...
		s:DrawTextEntryText(zmlab2.colors["white01"], tcol, color_white)
	end
