...
local ScreenData = {
    ...
    pages = {
        ...
        [2] = function(Furnace)
            draw.RoundedBox(0, -110, -32, 220, 5, zmlab2.colors["white01"])
            SimpleButton(-120, 10, "icon_cold", Furnace:OnDecrease(LocalPlayer()))
            SimpleButton(120, 10, "icon_hot", Furnace:OnIncrease(LocalPlayer()))
            draw.RoundedBox(10, -210 + ((300 / 3) * (Furnace:GetHeater() + 1)), -40, 20, 20, zmlab2.colors["white01"])
            ...
            draw.RoundedBox(0, -140, 40, (280 / zmlab2.config.Furnace.HeatingCylce_Duration) * heatTime, 20, zmlab2.colors["white01"])
            zmlab2.util.DrawOutlinedBox(-140, 40, 280, 20, 1, zmlab2.colors["white01"])
        end,
        [4] = function(Furnace)
