...
local function DrawButton(x, y,w,h, txt, hover)
    draw.SimpleText(txt, zmlab2.GetFont("zmlab2_font02"), x, y, zmlab2.colors["white01"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    zmlab2.util.DrawOutlinedBox(x - w / 2, y - h / 2, w, h, 4, zmlab2.colors["white01"])
    if hover then
