...
function zmlab2.PointerSystem.Paint()
    ...
    draw.SimpleText(zmlab2.PointerSystem.Data.ActionName, zmlab2.GetFont("zmlab2_vgui_font01"), zmlab2.wM *  650, zmlab2.hM * 895, zmlab2.colors["white01"], TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
    ...
    draw.SimpleText(zmlab2.language["Cancel"], zmlab2.GetFont("zmlab2_vgui_font01"), zmlab2.wM * 1350, zmlab2.hM * 895, zmlab2.colors["white01"], TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
    surface.SetDrawColor(zmlab2.colors["white01"])
